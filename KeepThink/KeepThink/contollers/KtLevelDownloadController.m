...
#import "KtLevelDownloadController.h"
...
@interface KtLevelDownloadController ()
...
@implementation KtLevelDownloadController
...
-(void)URLSessionDidFinishEventsForBackgroundURLSession:(NSURLSession *)session{
    KtAppDelegate *appDelegate = [UIApplication sharedApplication].delegate;
